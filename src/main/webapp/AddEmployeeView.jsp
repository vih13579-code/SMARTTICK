        ...
        <div class="content">
            ...
            <main class="admin-page-stack">
                <div class="admin-page-title">
                    <div>
                        <h1>Add Employee</h1>
                        <p>Create a staff account and assign its administration role.</p>
                    </div>
                ...
                <form class="employee-form-card"
                    ...
                    <div class="employee-form-fields">
                        ...
                        <div>
                            ...
                            <input class="form-control" id="employeeName" type="text"
                                   ...
                                   value="${fn:escapeXml(txtName)}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <small>At least 8 characters with uppercase and special character.</small>
                        </div>
                        ...
                        <div>
                            ...
                            <input class="form-control" id="employeePhone" type="tel"
                                   ...
                                   value="${fn:escapeXml(txtPhoneNumber)}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input class="form-control" id="employeeEmail" type="email"
                                   ...
                                   value="${fn:escapeXml(txtEmail)}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input class="form-control" id="employeeCreatedDate" type="date"
                                   name="txtCreatedDate"
                                   value="${fn:escapeXml(txtCreatedDate)}" readonly required>
                        </div>

                        <div>
                            <label class="form-label" for="employeeStatus">Status</label>
                            <select class="form-select" id="employeeStatus" name="txtStatus" required>
                                <option value="1" ${requestScope.txtStatus == null || txtStatus == 1 ? 'selected' : ''}>Active</option>
                                <option value="0" ${txtStatus == 0 ? 'selected' : ''}>Disabled</option>
                            </select>
                        </div>
                    ...
                    <div class="employee-avatar-editor">
                        ...
                        <img id="avatarPreview" class="employee-avatar-preview"
                             src="${pageContext.request.contextPath}/assets/imgs/Employee/${not empty currentAvatar ? currentAvatar : 'defauft.png'}"
