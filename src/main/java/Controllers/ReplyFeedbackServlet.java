    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                prDAO.updateisReadComment(rateID);
                 if(count>0){
                    response.sendRedirect(request.getContextPath() + "/ViewListNewFeedbackServlet?&success=created");
                 }else{
                    response.sendRedirect(request.getContextPath() + "/ViewListNewFeedbackServlet?&success=deleted");
                 }
